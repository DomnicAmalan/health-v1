...
export const COMMON_SHORTCUTS = {
  // Navigation
  OPEN_ACCESSIBILITY: { id: 'open-accessibility', keys: ['Alt', 'A'], description: 'Open accessibility settings' },
  TOGGLE_VOICE_COMMANDS: { id: 'toggle-voice', keys: ['Ctrl', 'Shift', 'V'], description: 'Toggle voice commands' },
