...
import { keyboardShortcutManager, COMMON_SHORTCUTS } from '@/lib/keyboard/shortcuts';
            ...
            <Box key={category}>
              ...
              <Stack spacing="sm">
                {categoryShortcuts.map((shortcut) => (
                  <Box key={shortcut.id} className="flex items-center justify-between py-2 border-b">
