 ...
 * Note: These types are duplicated from @lazarus-life/shared to avoid circular dependencies.
 * The canonical source is in shared/src/types/components/registry.ts
 */
...
export interface ActionItem {
  ...
  readonly voiceCommand?: string | string[];
...
export interface ComponentConfig {
  ...
  readonly i18nKey?: string;
  readonly voiceInteractable?: boolean;
  readonly voiceDescription?: string;
  readonly actionItems?: ActionItem[];
  readonly componentStructure?: ComponentStructure;
}
