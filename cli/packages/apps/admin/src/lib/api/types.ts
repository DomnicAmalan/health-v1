...
// Admin-specific UserInfo with organization_id and id instead of sub
export interface UserInfo extends Omit<SharedUserInfo, "sub"> {
  id: string;
  username: string;
...
// Alias for clarity
export type UserInfoWithOrg = UserInfo;
