...
async fn async_main() -> Result<(), String> {
    ...
    let protected_routes = axum::Router::new()
        ...
        // Visual Workflow Management (n8n-style)
        .route("/v1/admin/workflows", axum::routing::post(admin_service::handlers::workflow_handlers::create_workflow))
        .route("/v1/admin/workflows", axum::routing::get(admin_service::handlers::workflow_handlers::list_workflows))
        .route("/v1/admin/workflows/{id}", axum::routing::get(admin_service::handlers::workflow_handlers::get_workflow))
        .route("/v1/admin/workflows/{id}", axum::routing::put(admin_service::handlers::workflow_handlers::update_workflow))
        .route("/v1/admin/workflows/{id}", axum::routing::delete(admin_service::handlers::workflow_handlers::delete_workflow))
        .route("/v1/admin/workflows/{id}/clone", axum::routing::post(admin_service::handlers::workflow_handlers::clone_workflow))
        .route("/v1/admin/workflows/{id}/activate", axum::routing::post(admin_service::handlers::workflow_handlers::activate_workflow))
        .route("/v1/admin/workflows/{id}/deactivate", axum::routing::post(admin_service::handlers::workflow_handlers::deactivate_workflow))
        .route("/v1/admin/workflows/{id}/start", axum::routing::post(admin_service::handlers::workflow_handlers::start_instance))
        .route("/v1/admin/workflows/{id}/instances", axum::routing::get(admin_service::handlers::workflow_handlers::list_instances))
        .route("/v1/admin/workflow-instances/{id}", axum::routing::get(admin_service::handlers::workflow_handlers::get_instance))
        .route("/v1/admin/workflow-instances/{id}/pause", axum::routing::post(admin_service::handlers::workflow_handlers::pause_instance))
        .route("/v1/admin/workflow-instances/{id}/resume", axum::routing::post(admin_service::handlers::workflow_handlers::resume_instance))
        .route("/v1/admin/workflow-instances/{id}/cancel", axum::routing::post(admin_service::handlers::workflow_handlers::cancel_instance))
        .route("/v1/admin/workflow-tasks", axum::routing::get(admin_service::handlers::workflow_handlers::list_tasks))
        .route("/v1/admin/workflow-tasks/{id}", axum::routing::get(admin_service::handlers::workflow_handlers::get_task))
        .route("/v1/admin/workflow-tasks/{id}/claim", axum::routing::post(admin_service::handlers::workflow_handlers::claim_task))
        .route("/v1/admin/workflow-tasks/{id}/unclaim", axum::routing::post(admin_service::handlers::workflow_handlers::unclaim_task))
        .route("/v1/admin/workflow-tasks/{id}/complete", axum::routing::post(admin_service::handlers::workflow_handlers::complete_task))
        ...
        // Workflow routes (n8n-style orchestration)
        .route("/v1/workflows", axum::routing::get(crate::presentation::api::handlers::workflow_handlers::list_workflows))
        .route("/v1/workflows", axum::routing::post(crate::presentation::api::handlers::workflow_handlers::create_workflow))
        .route("/v1/workflows/{workflow_id}", axum::routing::get(crate::presentation::api::handlers::workflow_handlers::get_workflow))
        .route("/v1/workflows/{workflow_id}", axum::routing::put(crate::presentation::api::handlers::workflow_handlers::update_workflow))
        .route("/v1/workflows/{workflow_id}", axum::routing::delete(crate::presentation::api::handlers::workflow_handlers::delete_workflow))
        .route("/v1/workflows/{workflow_id}/instances", axum::routing::post(crate::presentation::api::handlers::workflow_handlers::start_workflow_instance))
        .route("/v1/workflow-instances", axum::routing::get(crate::presentation::api::handlers::workflow_handlers::list_workflow_instances))
        .route("/v1/workflow-instances/{instance_id}", axum::routing::get(crate::presentation::api::handlers::workflow_handlers::get_workflow_instance))
        .route("/v1/workflow-tasks", axum::routing::get(crate::presentation::api::handlers::workflow_handlers::list_tasks))
        .route("/v1/workflow-tasks/{task_id}/claim", axum::routing::post(crate::presentation::api::handlers::workflow_handlers::claim_task))
        .route("/v1/workflow-tasks/{task_id}/complete", axum::routing::post(crate::presentation::api::handlers::workflow_handlers::complete_task))
        .route("/v1/workflows/events/{event_type}", axum::routing::post(crate::presentation::api::handlers::workflow_handlers::emit_event))
        .route("/v1/connectors", axum::routing::get(crate::presentation::api::handlers::workflow_handlers::list_connectors))
        .with_state(app_state_arc.clone())
