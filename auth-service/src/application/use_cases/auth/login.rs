use crate::application::dto::{LoginRequest, LoginResponse, LoginUserResponse};
use crate::domain::repositories::{UserRepository, RefreshTokenRepository, RoleRepository, PermissionRepository};
...
impl LoginUseCase {
    ...
    pub async fn execute(&self, request: LoginRequest) -> AppResult<LoginResponse> {
        ...
        let refresh_token = crate::domain::repositories::refresh_token_repository::RefreshToken {
            id: Uuid::new_v4(),
            user_id: user.id,
            token_hash,
